<template>
    <div class="main">
        ...
        <div class="well-display">
            ...
            <div class="well">
                <span class="amount" @click="filter = 2">{{ numberOfTwoStarReviews }}</span>
        ...
        <!-- Once clicked, showForm becomes false -->
        ...
        <!-- Consider how what we change will be affected -->
...
export default {
    ...
    // Computed properties are reactive and change state
    computed: {
        averageRating(vm) {
        ...
        filteredReviews(vm) {
            var newArray = vm.reviews.filter( (review) => {
                // Goes through the array one at a time compares the value, if it's 0, returns it
                // if it's not equal to the rating, it leaves them out of the array
                // In the else statement, it starts comparing the respective rating to filter
                // Bound to filter and review object (vm)
                // It becomes reactive to filter
    ...
    methods: {
        // Methods have to be CALLED to be used
        // Methods SUPPORT Computed

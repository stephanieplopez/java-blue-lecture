 ...
 * the parent element that is passed to me. -- We added in the 'reviewer'
 *
...
/**
 * I will add the rating div along with a star image for the number 
 * of ratings 1-5
...
function addRating(parent, numberOfStars) {
  ...
  // Set one start image for each rating -- use forLoop
  for (let n = 0; i < numberOfStars; n++) {
    //Set the image (attribute) and set the source (attribute)
    const star = document.createElement('img');
    // img src="img/star.png" class ="ratingStar"
    // set the attributes, order does not matter
    star.setAttribute('class', 'ratingStar');
    star.src = 'img/star.png';
    // append the star to the rating
    rating.appendChild(star);
  }
  // append rating to parent

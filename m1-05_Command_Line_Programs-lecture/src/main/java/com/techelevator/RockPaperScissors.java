...
public class RockPaperScissors {
	...
	public static void main(String[] args) {
		...
		// 1. First we create a scanner
		Scanner in = new Scanner(System.in);
		Random randomGenerator = new Random();
		
		while (true) {
		
		//  to use a for loop it's:
//		for (; true;) {

			// 2. Give user choices
			System.out.print("Select (R)ock, (P)aper, or (S)cissors, or (Q)uit. Choose wisely >>>");
			// Store user input, used UpperCase to convert input to
			...
			// We chose 3 here because we want it to generate between 0 1 2, 3 is EXCLUDED
